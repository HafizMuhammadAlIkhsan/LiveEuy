          ...
          <div className="flex items-center justify-between gap-2 sm:gap-4">
            ...
            <div className="flex items-center gap-1.5 sm:gap-3 flex-shrink-0">
              ...
              <div className="relative" ref={profileRef}>
                ...
                >
                  <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-gradient-to-tr from-amber-500 via-rose-500 to-indigo-500 p-0.5">
                ...
                {showProfileMenu && (
                  <div className="absolute top-full right-0 mt-2 w-52 sm:w-56 rounded-2xl glass-dropdown p-2 shadow-2xl z-50 animate-fade-in text-xs sm:text-sm">
                    <div className="px-3 py-2 border-b border-white/10">
                      <p className="font-semibold text-white truncate">Hafiz Muhammad</p>
                      <p className="text-[11px] text-brand-400 font-medium">Paket VIP Cinema Ultra</p>
                    </div>
                    <div className="py-1">
                      <button
                        onClick={() => {
                      ...
                      <button
                        onClick={() => {
                          alert('Pengaturan preferensi video & audio.');
                          setShowProfileMenu(false);
                        }}
                        className="w-full flex items-center gap-2 px-3 py-2 rounded-lg text-slate-300 hover:text-white hover:bg-white/10 transition-colors"
                      >
